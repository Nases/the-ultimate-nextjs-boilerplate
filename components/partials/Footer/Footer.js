        ...
        <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="xl:col-span-1">
              ...
              <p className="mt-8 text-common-light text-base leading-6 test">
                Making the world a better place through constructing elegant hierarchies.
              </p>
              <p>
                <i aria-hidden className="fas fa-envelope text-common-lighter"></i>
                <span className="text-common-light">
                  {` ${companyInfo.email}`}
                </span>
              </p>
              <div className="mt-8 flex">
                <a href="#" className="text-common-lighter hover:text-common-light">
                  <span className="sr-only">Facebook</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="#" className="ml-6 text-common-lighter hover:text-common-light">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h4 className="text-sm leading-5 font-semibold tracking-wider text-common-lighter uppercase">
                    Solutions
                  </h4>
                  <ul className="mt-4">
                    <li>
                      <a href="#" className="text-base leading-6 text-common-light hover:text-common-dark">
                        Marketing
                      </a>
                    </li>
                    <li className="mt-4">
                  ...
                  <ul className="mt-4">
                    ...
                    <li className="mt-4">
                      <Link href="/policies/privacy">
                        <a className="text-base leading-6 text-common-light hover:text-common-dark">
                          Privacy
                        </a>
                      </Link>
                    </li>
          ...
          <div className="md:grid md:grid-cols-2 mt-12 border-t border-common pt-8">
            <p className="text-base leading-6 text-common-lighter md:text-left">
              Made with <i aria-hidden className="fas fa-heart hover:text-red-600"></i> & <i aria-hidden className="fas fa-coffee hover:text-yellow-700"></i> in California.
            </p>
