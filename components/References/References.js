const References = () => {
  return (
    <div className="bg-gray-50 mt-10">
      <h3 className='text-2xl font-extrabold text-gray-800 leading-10 text-center max-w-2xl m-auto'>Companies that have hired applicants who used our resume builder</h3>
      <div className="max-w-screen-xl mx-auto py-14 px-4 sm:px-6 lg:px-8">
